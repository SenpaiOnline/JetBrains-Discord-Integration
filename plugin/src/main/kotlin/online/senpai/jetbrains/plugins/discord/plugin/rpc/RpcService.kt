...
package online.senpai.jetbrains.plugins.discord.plugin.rpc

import online.senpai.jetbrains.plugins.discord.plugin.DiscordPlugin
import online.senpai.jetbrains.plugins.discord.plugin.rpc.connection.DiscordConnection
import online.senpai.jetbrains.plugins.discord.plugin.rpc.connection.DiscordIpcConnection
import online.senpai.jetbrains.plugins.discord.plugin.rpc.connection.DiscordRpcConnection
import online.senpai.jetbrains.plugins.discord.plugin.utils.DisposableCoroutineScope
import online.senpai.jetbrains.plugins.discord.plugin.utils.debugLazy
import online.senpai.jetbrains.plugins.discord.plugin.utils.lowercase
...
class RpcService : DisposableCoroutineScope {
    ...
    private fun createConnection(appId: Long): DiscordConnection {
        ...
        return forName(System.getenv()["online.senpai.jetbrains.plugins.discord.plugin.rpc.connection"]?.lowercase())
            ?: forName(System.getProperty("online.senpai.jetbrains.plugins.discord.plugin.rpc.connection")?.lowercase())
