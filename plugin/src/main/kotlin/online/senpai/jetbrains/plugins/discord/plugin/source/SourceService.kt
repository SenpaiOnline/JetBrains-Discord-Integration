...
package online.senpai.jetbrains.plugins.discord.plugin.source
...
class SourceService {
    ...
    init {
        val env = System.getenv("online.senpai.jetbrains.plugins.discord.plugin.source")?.split(':', limit = 2) ?: listOf("")
        val platform = env[0]
