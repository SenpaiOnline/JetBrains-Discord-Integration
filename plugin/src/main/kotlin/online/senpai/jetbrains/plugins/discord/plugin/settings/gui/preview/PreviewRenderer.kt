...
package online.senpai.jetbrains.plugins.discord.plugin.settings.gui.preview

import online.senpai.jetbrains.plugins.discord.plugin.data.Data
import online.senpai.jetbrains.plugins.discord.plugin.data.dataService
import online.senpai.jetbrains.plugins.discord.plugin.render.RenderContext
import online.senpai.jetbrains.plugins.discord.plugin.render.Renderer
import online.senpai.jetbrains.plugins.discord.plugin.rpc.RichPresence
import online.senpai.jetbrains.plugins.discord.plugin.rpc.rpcService
import online.senpai.jetbrains.plugins.discord.plugin.settings.settings
import online.senpai.jetbrains.plugins.discord.plugin.source.sourceService
import online.senpai.jetbrains.plugins.discord.plugin.time.timeActive
import online.senpai.jetbrains.plugins.discord.plugin.time.timeOpened
import online.senpai.jetbrains.plugins.discord.plugin.utils.*
import online.senpai.jetbrains.plugins.discord.plugin.utils.Color.blurple
import online.senpai.jetbrains.plugins.discord.plugin.utils.Color.darkOverlay
import online.senpai.jetbrains.plugins.discord.plugin.utils.Color.green
import online.senpai.jetbrains.plugins.discord.plugin.utils.Color.greenTranslucent
import online.senpai.jetbrains.plugins.discord.plugin.utils.Color.whiteTranslucent60
import online.senpai.jetbrains.plugins.discord.plugin.utils.Color.whiteTranslucent80
...
import online.senpai.jetbrains.plugins.discord.plugin.rpc.User as RPCUser
